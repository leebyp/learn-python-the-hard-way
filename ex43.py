...
#using methods for Map.opening_scene, Map.next_scene
...
#scenes done before Map because need to reference them
class Map(object):
...
#making a Map
a_game = Engine(a_map)
#handing map to an Engine
a_game.play()
#calling play to make game work